...
public class SignupController {
    ...
    public ResponseEntity<UserCreateResponseModel> createUser(
        ...
        UserCreateResponseModel userResponseModel = modelMapper.map(createdDto, UserCreateResponseModel.class);
        if(userResponseModel.getGroupName() == null) userResponseModel.setGroupName("default");
