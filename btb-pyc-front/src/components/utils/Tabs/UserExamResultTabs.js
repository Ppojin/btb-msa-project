...
// import css styles
import UserExamResultTabsSytle from 'assets/jss/components/styles/UserExamResultTabsStyle.js'

export default function UesrExamResultTabs(props){
    const [value, setValue] =React.useState(0);
    const handleChange =(e,value)=>{
        setValue(value);
    }
    const classes = UserExamResultTabsSytle();
